...
EvtData_Window_Close::EvtData_Window_Close(bool confirm_close) : m_confirm_close(confirm_close) {}
...
IEventDataPtr EvtData_Window_Close::VCopy() const {
    return IEventDataPtr(new EvtData_Window_Close(m_confirm_close));
}
