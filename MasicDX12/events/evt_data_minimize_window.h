...
class EvtData_Minimize_Window : public BaseEventData {
    ResizeEventArgs m_state;

public:
    static const EventTypeId sk_EventType = 0x7b75be06;
    static const std::string sk_EventName;

    EvtData_Minimize_Window();
    EvtData_Minimize_Window(ResizeEventArgs e);
    EvtData_Minimize_Window(int width, int height, WindowState state);
    ...
    friend std::ostream& operator<<(std::ostream& os, const EvtData_Minimize_Window& evt);
};