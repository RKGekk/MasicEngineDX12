...
class EvtData_Mouse_Button_Pressed : public BaseEventData {
    MBEventArgs m_state;

public:
    static const EventTypeId sk_EventType = 0x69466edf;
    ...
    friend std::ostream& operator<<(std::ostream& os, const EvtData_Mouse_Button_Pressed& evt);
};