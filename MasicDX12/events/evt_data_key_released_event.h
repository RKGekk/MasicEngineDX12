...
class EvtData_Key_Released_Event : public BaseEventData {
    KeyEventArgs m_state;

public:
    static const EventTypeId sk_EventType = 0x200335af;
    ...
    friend std::ostream& operator<<(std::ostream& os, const EvtData_Key_Released_Event& evt);
};